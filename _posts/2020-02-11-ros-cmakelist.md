...
# add_compile_options(-std=c++11) # compile옵션입니다.
# 컴파일 옵션에서는 컴파일러를 선택하면 됩니다.
...
#  LIBRARIES tf_tutorials
#  CATKIN_DEPENDS nav_msgs roscpp rospy sensor_msgs std_msgs tf tf2
#  DEPENDS system_lib
)
...
#   src/${PROJECT_NAME}/tf_tutorials.cpp
# )
...
# add_executable(${PROJECT_NAME}_node src/tf_tutorials_node.cpp)
...
# catkin_add_gtest(${PROJECT_NAME}-test test/test_tf_tutorials.cpp)
